...
export class RegisterMemberTeamDto {
    private constructor(
        public id: number,
        public name: string,
        public post: string,
    ...
    static create(object: { [key: string]: any; }): [string?, RegisterMemberTeamDto?] {
        ...
        return [
            undefined,
            new RegisterMemberTeamDto(id, name, post, lastNames, email, password, cel, role, img)
        ]
    }
}   

export class LoginMemberTeamDto {
    private constructor(
        public email: string,
        public password: string
    ){}

    static create(object: { [key: string]: any; }): [string?, LoginMemberTeamDto?] {
        ...
        return [
            undefined,
            new LoginMemberTeamDto(email, password)
        ]
    }
}