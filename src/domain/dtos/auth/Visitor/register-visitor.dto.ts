...
export class RegisterVisitorDto {
    ...
    static create(object: { [key: string]: any; }): [string?, RegisterVisitorDto?] {
        ...
        return [
            undefined,
            new RegisterVisitorDto(id, name, post, lastNames, email, password, cel, role, img)
        ]
    }
}
...
export class LoginVisitorDto {
    ...
    static create(object: { [key: string]: any; }): [string?, LoginVisitorDto?] {
        ...
        return [
            undefined,
            new LoginVisitorDto(email, password)
        ]
    }
}